...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    elseif (isset($_POST["action"]) && $_POST["action"] == "update_table_price") {
        ...
        if (tablePrice($table_price, $conn)) {
            echo '<script>alert("Table price updated successfully")</script>';
                echo '<script>window.location="absmenu.php"</script>';
        } else {
            echo '<script>alert("Table price Not updated ")</script>';
                echo '<script>window.location="absmenu.php"</script>';
        }
        ...
        if (peakPrice($peak_price, $conn)) {
            echo '<script>alert("Peak price updated successfully")</script>';
            echo '<script>window.location="absmenu.php"</script>';
        } else {
            echo '<script>alert("Peak price Not updated ")</script>';
                echo '<script>window.location="absmenu.php"</script>';
        }
}
}
...
function uploadImage() {
    $targetDirectory = "./images/"; // Update this path to the correct directory
