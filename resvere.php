...
if(isset($_POST["place_order"])) {
    $username = $_SESSION['username'];
    $to_date = $_POST['datefrom'];
    $order_times = isset($_POST['time']) ? mysqli_real_escape_string($conn, $_POST['time']) : '';
    foreach($_SESSION["shopping_cart"] as $keys => $values) {
        ...
        // $query = "INSERT INTO orders (username, item_name, item_quantity, item_price, total_price,to_date,order_times) VALUES ('$username', '$item_name', '$item_quantity', '$item_price', '$total_price','$to_date','$order_times')";
